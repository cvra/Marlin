...
#define STRING_SPLASH_LINE2 CVRA          // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "CVRA FUCKING 3D PRINTER"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 152.381, 152.381, 3200, 130 }
